...
def find_afterparties():
    ...
    if location and distance and measurement:
        ...
        payload = {
            ...
            'sort_by':sort,
            'token':os.environ['EVENTBRITE_ANONYMOUS']
        }
...
def create_eventbrite_event():
    ...
    start_time = request.form.get('start-time') + ':00'
    end_time = request.form.get('end-time')+ ':00'
    start_time_utc = request.form.get('start-time') + ':00Z'
    end_time_utc = request.form.get('end-time') + ':00Z'
    timezone = request.form.get('timezone')
    currency = request.form.get('currency')

    print('start_time: {}'.format(start_time))
    print('start_time_utc: {}'.format(start_time_utc))

    print('end_time: {}'.format(end_time))
    print('end_time_utc: {}'.format(end_time_utc))
    ...
    url = 'https://www.eventbriteapi.com/v3/organizations/{}/events/'.format(os.environ['USER_ID'])
    # data = {'This': ['Some', 'mock', 'JSON']}
